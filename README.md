...
**Jingle** 是速通圈内久负盛名、功能强大的工具箱。然而，原版 Jingle 的界面采用了硬编码的英文设计，对于许多国内的新手玩家或英语不佳的朋友来说，存在一定的操作门槛。

为了改善这一体验，我通过对源码的调整与文本提取，制作了这个**汉化版本**。

### ✨ 汉化内容

- **深度覆盖**：对 Jingle 主界面的绝大部分功能菜单、提示信息、设置选项进行了汉化。除了日志页。

- **解决乱码**：对读取文件操作指定了UTF-8编码方式，解决了在部分电脑上出现中文乱码的问题。

- **插件同步**：同时完成了 Jingle 内置的 **4 个插件** 的汉化。
...
汉化工作难免有疏漏，如果你在使用中遇到任何问题，或者有更好的翻译建议，欢迎通过以下方式与我交流：

- **提交 Issue**：在本项目页面提交问题反馈。

- **联系我**：QQ 1975818797


> **致谢**：感谢原作者[DuncanRuns](https://github.com/DuncanRuns)提供的优秀工具，本项目仅做汉化处理，旨在服务中文社区玩家。
